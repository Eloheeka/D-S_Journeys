...
export function About() {
  return (
    <div className="pt-20">
      ...
      <Reveal className="py-20 px-4 bg-secondary">
        <div className="max-w-7xl mx-auto">
          ...
          <StaggerGroup className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <StaggerItem className="interactive-card text-center bg-background/75 px-6 py-8">
      ...
      <Reveal className="py-20 px-4 max-w-5xl mx-auto">
        <div className="text-center mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Our guides are passionate storytellers who bring East Africa to life. Many have
              been with us for years and are experts in wildlife, birding, photography, and
